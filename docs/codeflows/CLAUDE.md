...
- `docs/codeflows/lifecycle-workflow.md` — Lifecycle workflow engine (state machine, WorkflowEngine, GithubPollerManager, step router, dispatch and readiness flows)
