...
- **No agent CLI is installed here.** Agent-specific installs (e.g. the Claude Code CLI), app config, and the worker binaries live in the agent layer built on top of this one — see `containers/agent-claude/`
