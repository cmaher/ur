...
If acceptance tests are failing, run `cargo make acceptance-ci` via hostexec to build isolated test images and run the full acceptance test suite. Fix any failures and re-run until clean.
