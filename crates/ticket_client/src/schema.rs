    ...
    vec![
        Command {
            ...
            params: vec![
                Param {
                    ...
                    param_type: "string",
                    required: true,
                    description: "Ticket title (positional)",
                },
                Param {
                    name: "--type",
                    param_type: "string",
                    required: false,
                    description: "Ticket type: epic or task (default: task)",
                },
                Param {
                    name: "--parent",
                    param_type: "string",
                    required: false,
                    description: "Parent ticket ID (alias: --epic)",
                },
                Param {
                    name: "--priority",
                    param_type: "integer",
                    required: false,
                    description: "Priority, lower is higher (default: 0)",
                },
                Param {
                    name: "--body",
                    param_type: "string",
        ...
        Command {
            ...
            params: vec![
                Param {
                    ...
                    param_type: "string",
                    required: false,
                    description: "Filter by parent epic ID (alias: --parent)",
                },
                Param {
                    name: "--type",
                    param_type: "string",
        ...
        Command {
            ...
            params: vec![Param {
                ...
                param_type: "string",
                required: true,
                description: "Ticket ID (positional)",
            }],
        },
        Command {
            name: "update",
            ...
            params: vec![
                ...
                Param {
                    ...
                    param_type: "string",
                    required: false,
                    description: "New parent ticket ID (alias: --epic)",
                },
                Param {
                    name: "--force",
                    param_type: "boolean",
                    required: false,
                    description: "Force update (e.g. close epic with open children)",
                },
            ],
        },
        Command {
            ...
            params: vec![
                ...
                Param {
                    ...
                    param_type: "string",
                    required: true,
                    description: "Metadata key (positional)",
                },
                Param {
                    name: "value",
                    param_type: "string",
                    required: true,
                    description: "Metadata value (positional)",
                },
            ],
        },
        Command {
            ...
            params: vec![
                ...
                Param {
                    ...
                    param_type: "string",
                    required: true,
                    description: "Metadata key to delete (positional)",
                },
            ],
        },
        Command {
            ...
            params: vec![
                ...
                Param {
                    ...
                    param_type: "string",
                    required: true,
                    description: "Activity message (positional)",
                },
                Param {
                    name: "--meta",
                    param_type: "string",
                    required: false,
                    description: "Metadata key=value pairs (repeatable)",
                },
            ],
        },
        Command {
        ...
        Command {
            ...
            params: vec![
                Param {
                    ...
                    param_type: "string",
                    required: true,
                    description: "Ticket ID that is blocked (positional)",
                },
                Param {
                    name: "blocked_by_id",
                    param_type: "string",
                    required: true,
                    description: "Ticket ID that is the blocker (positional)",
                },
            ],
        },
        Command {
        ...
        Command {
            ...
            params: vec![
                Param {
                    ...
                    param_type: "string",
                    required: true,
                    description: "First ticket ID (positional)",
                },
                Param {
                    name: "linked_id",
                    param_type: "string",
                    required: true,
                    description: "Second ticket ID (positional)",
                },
            ],
        },
        Command {
        ...
        Command {
            ...
            params: vec![Param {
                ...
                param_type: "string",
                required: true,
                description: "Epic ticket ID (positional)",
            }],
        },
        Command {
            name: "status",
            ...
            params: vec![Param {
                ...
                param_type: "string",
                required: false,
                description: "Project key to filter by ID prefix (e.g. 'ur' shows ur-* tickets)",
            }],
        },
    ]
}
