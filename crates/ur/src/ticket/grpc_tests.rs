...
impl TicketService for MockTicketStore {
    ...
    async fn create_workflow(
        &self,
        _req: Request<ur_rpc::proto::ticket::CreateWorkflowRequest>,
    ) -> Result<Response<ur_rpc::proto::ticket::CreateWorkflowResponse>, Status> {
        Err(Status::unimplemented("not implemented in mock"))
    }

    async fn cancel_workflow(
        &self,
        _req: Request<ur_rpc::proto::ticket::CancelWorkflowRequest>,
    ...
    async fn stall_workflow(
        &self,
        _req: Request<ur_rpc::proto::ticket::StallWorkflowRequest>,
    ) -> Result<Response<ur_rpc::proto::ticket::StallWorkflowResponse>, Status> {
        Err(Status::unimplemented("not implemented in mock"))
    }
