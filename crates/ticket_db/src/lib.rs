...
pub use model::{
    ...
    ExportTicket, ExportTicketComment, ImportError, LifecycleStatus, MetadataMatchTicket,
    NewTicket, Ticket, TicketComment, TicketFilter, TicketStatus, TicketType, TicketUpdate,
    UiEventRow,
};
